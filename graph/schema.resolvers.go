...
func (r *mutationResolver) UpdatePostCommentsEnabled(ctx context.Context, id string, commentsEnabled bool) (*model.Post, error) {
	panic(fmt.Errorf("not implemented: UpdatePostCommentsEnabled - updatePostCommentsEnabled"))
}
